...
const LANDING_TYPE = 'solution' as const;
const ROUTE_PATH = '/solutions';
const BREADCRUMB_LABEL = 'Giải pháp';
...
export default async function SolutionLayout({ params, children }: Props) {
  const { slug } = await params;
