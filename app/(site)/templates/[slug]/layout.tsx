...
const LANDING_TYPE = 'template' as const;
const ROUTE_PATH = '/templates';
const BREADCRUMB_LABEL = 'Templates';
...
export default async function TemplateLayout({ params, children }: Props) {
  const { slug } = await params;
