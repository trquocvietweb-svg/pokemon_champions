...
const LANDING_TYPE = 'guide' as const;
const ROUTE_PATH = '/guides';
const BREADCRUMB_LABEL = 'Hướng dẫn';
...
export default async function GuideLayout({ params, children }: Props) {
  const { slug } = await params;
